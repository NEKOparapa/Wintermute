...
class EventMemoryConsolidator:
    ...
    def consolidate_event(self, event: dict[str, Any]) -> ConsolidationResult:
        ...
        if event_id in self.memory_store.source_event_ids_for_kind(self.memory_kind, label):
